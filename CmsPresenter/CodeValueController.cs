...
namespace CMSPresenter
{
    ...
    public class CodeValueController
    {
        ...
        public static List<MemberTypeItem> MemberTypeCodes2()
        {
            ...
            var list = HttpRuntime.Cache[DbUtil.Db.Host + NAME] as List<MemberTypeItem>;
            if (list == null)
            {
        ...
        public static List<string> VolunteerOpportunities()
        {
            const string NAME = "VolunteerOpportunities";
            var list = HttpRuntime.Cache[DbUtil.Db.Host + NAME] as List<string>;
            if (list == null)
            {
