...
[BankAccount] [varchar] (250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[Contribution] ADD CONSTRAINT [FK_Contribution_ExtraData] FOREIGN KEY ([ExtraDataId]) REFERENCES [dbo].[ExtraData] ([Id])
GO
