...
GO
ALTER TABLE [dbo].[Page] ADD CONSTRAINT [PK_CMS_Page] PRIMARY KEY CLUSTERED  ([PageID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Page] ADD CONSTRAINT [CreatedPages__CreatedBy] FOREIGN KEY ([CreatedById]) REFERENCES [dbo].[Users] ([UserId])
GO
ALTER TABLE [dbo].[Page] ADD CONSTRAINT [ModifiedPages__ModifiedBy] FOREIGN KEY ([ModifiedById]) REFERENCES [dbo].[Users] ([UserId])
GO
