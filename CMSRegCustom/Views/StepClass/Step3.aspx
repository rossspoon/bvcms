<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site3.Master" Inherits="System.Web.Mvc.ViewPage<CMSRegCustom.Models.StepClassModel>" %>

<asp:Content ID="registerHead" ContentPlaceHolderID="TitleContent" runat="server">
    <title>Step 3 Registration</title>
</asp:Content>
    ...
    <% using (Html.BeginForm()) { %>
        <div>
            <fieldset>
                ...
                <tr>
                    <td><label for="MeetingId">Step 3 Class Dates</label></td>
                    <td><%= Html.DropDownList("MeetingId", Model.AvailableClasses("Step 3"))%></td>
