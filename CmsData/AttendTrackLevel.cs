...
namespace CmsData
{
	[Table(Name="lookup.AttendTrackLevel")]
	public partial class AttendTrackLevel : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.AttendTrackLevel = this;
		}

		private void detach_Organizations(Organization entity)
		{
			this.SendPropertyChanging();
			entity.AttendTrackLevel = null;
		}
