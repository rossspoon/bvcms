...
namespace CmsData
{
	[Table(Name="lookup.RegistrationType")]
	public partial class RegistrationType : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    #region Foreign Key Tables
   		...
   		[Association(Name="FK_Organizations_RegistrationType", Storage="_Organizations", OtherKey="RegistrationTypeId")]
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.RegistrationType = this;
		}

		private void detach_Organizations(Organization entity)
		{
			this.SendPropertyChanging();
			entity.RegistrationType = null;
		}
