...
namespace CmsData
{
    ...
    #region Columns
		...
		[Column(Name="toaddr", UpdateCheck=UpdateCheck.Never, Storage="_Toaddr", DbType="varchar(50)")]
		...
		[Column(Name="subject", UpdateCheck=UpdateCheck.Never, Storage="_Subject", DbType="varchar(80)")]
