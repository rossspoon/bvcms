...
namespace CmsData
{
	[Table(Name="lookup.GenderClass")]
	public partial class GenderClass : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    #region Columns
		...
		[Column(Name="Description", UpdateCheck=UpdateCheck.Never, Storage="_Description", DbType="varchar(20)")]
