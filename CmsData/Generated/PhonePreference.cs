...
namespace CmsData
{
	[Table(Name="lookup.PhonePreference")]
	public partial class PhonePreference : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    #region Foreign Key Tables
   		...
   		[Association(Name="FK_PEOPLE_TBL_PhonePreference", Storage="_People", OtherKey="PhonePrefId")]
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.PhonePreference = this;
		}

		private void detach_People(Person entity)
		{
			this.SendPropertyChanging();
			entity.PhonePreference = null;
		}
