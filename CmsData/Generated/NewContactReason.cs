...
namespace CmsData
{
	[Table(Name="lookup.NewContactReason")]
	public partial class NewContactReason : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    #region Foreign Key Tables
   		...
   		[Association(Name="FK_NewContacts_ContactReasons", Storage="_NewContacts", OtherKey="ContactReasonId")]
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.NewContactReason = this;
		}

		private void detach_NewContacts(NewContact entity)
		{
			this.SendPropertyChanging();
			entity.NewContactReason = null;
		}
