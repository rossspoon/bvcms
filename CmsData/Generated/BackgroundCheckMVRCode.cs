...
namespace CmsData
{
    ...
    #region Columns
		...
		[Column(Name="Code", UpdateCheck=UpdateCheck.Never, Storage="_Code", DbType="varchar(10) NOT NULL")]
		public string Code
		{
		...
		[Column(Name="StateAbbr", UpdateCheck=UpdateCheck.Never, Storage="_StateAbbr", DbType="varchar(3) NOT NULL")]
