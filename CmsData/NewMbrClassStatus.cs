...
namespace CmsData
{
	[Table(Name="lookup.NewMbrClassStatus")]
	public partial class NewMbrClassStatus : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    #region Foreign Key Tables
   		...
   		[Association(Name="FK_PEOPLE_TBL_NewMbrClassStatus", Storage="_People", OtherKey="NewMbrClassStatusId")]
	...
	#region Foreign Keys
		...
		{
			this.SendPropertyChanging();
			entity.NewMbrClassStatus = this;
		}

		private void detach_People(Person entity)
		{
			this.SendPropertyChanging();
			entity.NewMbrClassStatus = null;
		}
