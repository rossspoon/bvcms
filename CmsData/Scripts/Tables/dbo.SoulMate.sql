...
GO
ALTER TABLE [dbo].[SoulMate] ADD CONSTRAINT [HerSoulMates__Her] FOREIGN KEY ([HerId]) REFERENCES [dbo].[People] ([PeopleId])
GO
ALTER TABLE [dbo].[SoulMate] ADD CONSTRAINT [HisSoulMates__Him] FOREIGN KEY ([HimId]) REFERENCES [dbo].[People] ([PeopleId])
GO
