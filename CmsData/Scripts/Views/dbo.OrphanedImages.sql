...
WHERE (NOT EXISTS
                   (SELECT NULL AS Expr1
                    FROM   dbo.Picture AS p
                    WHERE (i.Id = SmallId) OR
                                   (i.Id = MediumId) OR
                                   (i.Id = LargeId))) AND (NOT EXISTS
                   (SELECT NULL AS Expr1
                    FROM   dbo.RecReg AS r
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'OrphanedImages', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', 1, 'SCHEMA', N'dbo', 'VIEW', N'OrphanedImages', NULL, NULL
GO
