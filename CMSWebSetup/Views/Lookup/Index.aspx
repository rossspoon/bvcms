<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<CMSWebSetup.Controllers.LookupController.Row>>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script src="/Content/js/jquery.jeditable.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function() {
            $(".clickEdit").editable("/Lookup/Edit/", {
            ...
            $("a.delete").click(function(ev) {
                if (confirm("are you sure?"))
                    $.post("/Lookup/Delete/" + $(this).attr("id"), { type: $('#type').val() }, function(ret) {
                        window.location = "/Lookup/Index/" + $('#type').val();
                    });
            });
        });
    </script>
