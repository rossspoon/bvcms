<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddContactorDialog.aspx.cs"
    Inherits="CMSWeb.AddContactorDialog" StylesheetTheme="Minimal" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="AddSelectedContactors" runat="server" OnClick="AddSelectedContactors_Click"
            Text="Add Selected" />
