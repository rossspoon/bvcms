...
{
    public partial class AddTaskDelegate : System.Web.UI.Page
    {
        public int TaskId;
        ...
        protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            if (e.CommandName == "select1")
            {
                ...
                Page.ClientScript.RegisterStartupScript(typeof(AddTaskDelegate), "closeThickBox", "self.parent.AddSelected();", true);
            }
        }
    }
}
