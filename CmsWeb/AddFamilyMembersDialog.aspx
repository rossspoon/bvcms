<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFamilyMembersDialog.aspx.cs"
    Inherits="CMSWeb.AddFamilyMembersDialog" StylesheetTheme="Minimal" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="AddSelectedFamilyMembers" runat="server" OnClick="AddSelectedFamilyMembers_Click"
            Text="Add Selected" />
        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Must have a name when adding"></asp:CustomValidator>
