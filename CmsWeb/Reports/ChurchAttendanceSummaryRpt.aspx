<%@ Page Language="C#" StylesheetTheme="Standard" AutoEventWireup="true" CodeBehind="ChurchAttendanceSummaryRpt.aspx.cs"
    MasterPageFile="~/Reports/Reports.Master" Inherits="CMSWeb.ChurchAttendanceSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        ...
        <asp:ListView ID="InterestPointInfo" runat="server" DataSourceID="dsInterestPointInfo">
            ...
            <ItemTemplate>
                <tr <%# Eval("Interest") == "Total" ? "class='totalrow'" : "" %> style='background-color: <%# (Container.DataItemIndex % 2 == 0)?"#eee":"#fff" %>'>
                    <td align="left">
        ...
        <asp:ListView ID="ListView2" runat="server" DataSourceID="dsGuestCentral">
            ...
            <ItemTemplate>
                <tr <%# Eval("HourLabel") == "Total" ? "class='totalrow'" : "" %> style='background-color: <%# (Container.DataItemIndex % 2 == 0)?"#eee":"#fff" %>'>
                    <td align="left">
