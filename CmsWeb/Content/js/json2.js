...
<script src="https://d3nwyuy0nl342s.cloudfront.net/0d4fb35a03d9556a0f727de6275394424092695f/javascripts/bundle_github.js" type="text/javascript"></script>
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="actions">
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/douglascrockford/JSON-js/watchers" title="Watchers" class="tooltipped downwards">462</a></li>
          <li class="forks"><a href="/douglascrockford/JSON-js/network" title="Forks" class="tooltipped downwards">21</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/douglascrockford/JSON-js/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="9a63344f1f49ba17a2365824d6ea3bb1ee3cefbb" /></div>
  ...
  <img src="https://d3nwyuy0nl342s.cloudfront.net/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.04267s from fe4.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
