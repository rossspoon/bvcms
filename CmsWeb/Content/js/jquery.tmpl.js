...
<html>
  <head>
    ...
    <link href="https://d3nwyuy0nl342s.cloudfront.net/0d4fb35a03d9556a0f727de6275394424092695f/stylesheets/bundle_github.css" media="screen" rel="stylesheet" type="text/css" />
    ...
    <script src="https://d3nwyuy0nl342s.cloudfront.net/0d4fb35a03d9556a0f727de6275394424092695f/javascripts/jquery/jquery-1.4.2.min.js" type="text/javascript"></script>
    <script src="https://d3nwyuy0nl342s.cloudfront.net/0d4fb35a03d9556a0f727de6275394424092695f/javascripts/bundle_common.js" type="text/javascript"></script>
<script src="https://d3nwyuy0nl342s.cloudfront.net/0d4fb35a03d9556a0f727de6275394424092695f/javascripts/bundle_github.js" type="text/javascript"></script>
  ...
  <link href="https://github.com/jquery/jquery-tmpl/commits/master.atom" rel="alternate" title="Recent Commits to jquery-tmpl:master" type="application/atom+xml" />
        ...
        <meta name="description" content="jquery-tmpl - A templating plugin for jQuery." />
    <script type="text/javascript">
      GitHub.nameWithOwner = GitHub.nameWithOwner || "jquery/jquery-tmpl";
      GitHub.currentRef = 'master';
      GitHub.commitSHA = "5ffd98011141b0df8f8f6f08abd50820e70e3125";
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2Fjquery%2Fjquery-tmpl%2Fblob%2Fmaster%2Fjquery.tmpl.js">Login</a></li>
    </ul>
    ...
    <div class="site">
      ...
      <div class="title-actions-bar">
        <h1>
          <a href="/jquery">jquery</a> / <strong><a href="/jquery/jquery-tmpl">jquery-tmpl</a></strong>
    ...
    <ul class="actions">
        ...
        <li class="for-owner" style="display:none"><a href="/jquery/jquery-tmpl/admin" class="minibutton btn-admin "><span><span class="icon"></span>Admin</span></a></li>
        <li>
          <a href="/jquery/jquery-tmpl/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '9a63344f1f49ba17a2365824d6ea3bb1ee3cefbb'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/jquery/jquery-tmpl/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '9a63344f1f49ba17a2365824d6ea3bb1ee3cefbb'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/jquery/jquery-tmpl/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '9a63344f1f49ba17a2365824d6ea3bb1ee3cefbb'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/jquery/jquery-tmpl/watchers" title="Watchers" class="tooltipped downwards">1,199</a></li>
          <li class="forks"><a href="/jquery/jquery-tmpl/network" title="Forks" class="tooltipped downwards">112</a></li>
        </ul>
      </li>
    </ul>
  ...
  <ul class="tabs">
    <li><a href="/jquery/jquery-tmpl" class="selected" highlight="repo_source">Source</a></li>
    ...
    <li><a href="/jquery/jquery-tmpl/pulls" highlight="repo_pulls">Pull Requests (2)</a></li>
      ...
      <li><a href="/jquery/jquery-tmpl/issues" highlight="issues">Issues (37)</a></li>
  ...
  <ul>
    <li>
      ...
      <a href="/jquery/jquery-tmpl/branches" class="dropdown">Switch Branches (2)</a>
      <ul>
        
          
          
            <li><a href="/jquery/jquery-tmpl/blob/gh-pages/jquery.tmpl.js" action="show">gh-pages</a></li>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/jquery/jquery-tmpl/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="9a63344f1f49ba17a2365824d6ea3bb1ee3cefbb" /></div>
...
<div class="flash-messages"></div>
  ...
  <div class="envelope commit">
    <div class="human">
        ...
        <div class="message"><pre><a href="/jquery/jquery-tmpl/commit/5ffd98011141b0df8f8f6f08abd50820e70e3125">Update step-by-step.html</a> </pre></div>
      

      <div class="actor">
        <div class="gravatar">
          
          <img src="https://secure.gravatar.com/avatar/49714f0dd44c46b27d7b2e9ee20061c9?s=140&d=https://d3nwyuy0nl342s.cloudfront.net%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="30" height="30"  />
        </div>
        <div class="name"><a href="/BorisMoore">BorisMoore</a> <span>(author)</span></div>
        <div class="date">
          <abbr class="relatize" title="2011-05-09 12:04:17">Mon May 09 12:04:17 -0700 2011</abbr>
        </div>
      </div>
    ...
    <div class="machine">
      <span>c</span>ommit&nbsp;&nbsp;<a href="/jquery/jquery-tmpl/commit/5ffd98011141b0df8f8f6f08abd50820e70e3125" hotkey="c">5ffd98011141b0df8f8f</a><br />
      <span>t</span>ree&nbsp;&nbsp;&nbsp;&nbsp;<a href="/jquery/jquery-tmpl/tree/5ffd98011141b0df8f8f6f08abd50820e70e3125" hotkey="t">c88f2553fe5294eb1533</a><br />
      
        <span>p</span>arent&nbsp;
        
        <a href="/jquery/jquery-tmpl/tree/f5deba5312ad95b04d7ad619c2a68a3e8e8a1d63" hotkey="p">f5deba5312ad95b04d7a</a>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="jquery.tmpl.js/">
      <b><a href="/jquery/jquery-tmpl/tree/7918f5307498f26fb5312aeea1d26c43ac887320">jquery-tmpl</a></b> / jquery.tmpl.js       <span style="display:none" id="clippy_3404">jquery.tmpl.js</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3404&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://d3nwyuy0nl342s.cloudfront.net/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3404&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="jquery.tmpl.js/">
          ...
          <ul class="big-actions">
            ...
            <li><a class="file-edit-link minibutton" href="/jquery/jquery-tmpl/file-edit/__current_ref__/jquery.tmpl.js"><span>Edit this file</span></a></li>
          </ul>
  ...
  <img src="https://d3nwyuy0nl342s.cloudfront.net/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.04549s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "9a63344f1f49ba17a2365824d6ea3bb1ee3cefbb"</script>
