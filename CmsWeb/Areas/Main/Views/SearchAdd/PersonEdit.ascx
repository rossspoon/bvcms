...
<% if (Model.index > 0)
   { %>
    <a class="cancel" href="/SearchAdd/Cancel/<%=Model.index %>">Cancel this participant</a>
<% } %>
        </td>
    </tr>
    <tr>
    ...
    <tr><td></td>
        ...
        <% if (!Model.Found.HasValue)
           { %>
            <a href="/SearchAdd/PersonFind/<%=Model.index %>" class="submitbutton">Find Record</a>
        <% }
           else
           { %>
           <p><%=CMSWeb.Models.SearchPeopleModel.NotFoundText %></p>
            <a href="/SearchAdd/PersonFind/<%=Model.index %>" class="submitbutton">Try Find Again</a>
            or <a href="/SearchAdd/ShowMoreInfo/<%=Model.index %>" class="submitbutton">Register as new</a>
        <% } %>
        </td>
    </tr>
    <% }
    ...
    <tr><td></td>
        <td><a href="/SearchAdd/SubmitNew/<%=Model.index %>" class="submitbutton">Submit</a></td>
    </tr>
    <% } %>
</table>
</td>
