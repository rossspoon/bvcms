<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<CMSWeb.Models.PersonEnrollmentsModel>" %>
<form id="enrollform" action="/Person/EnrollGrid/<%=Model.person.PeopleId %>">
