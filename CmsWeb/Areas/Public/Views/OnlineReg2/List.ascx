...
<%   //-----------------------REMOVE REGISTRATION---------------------------
   ...
   { %>
<a href="/OnlineReg2/Cancel/<%=p.index %>" class="close submitlink"><img src="/images/delete.gif" border="0" alt="cancel" title="cancel this registration" /></a>
<% } %>
...
<%   if (!Model.OnlyOneAllowed())
       { %>
        <a href="/OnlineReg2/AddAnotherPerson/" class="submitbutton">Register another</a> Or
    <% } %>
