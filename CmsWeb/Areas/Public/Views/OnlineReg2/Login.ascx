...
<table class="login box" cellspacing="6" style="width: auto" >
    ...
    <tr>
        <td colspan="2" align="center"><a href="/OnlineReg2/Login/" class="submitbutton" tabindex="3">Login</a>
...
<table class="login" cellspacing="6">
    ...
    <tr><td>Or you can register <a href="/OnlineReg2/NoLogin" class="submitlink">without an account</a> too.</td></tr>
</table>
