...
namespace CmsWeb.Contributions.Reports
{
    public partial class ContributionStatementExtract : System.Web.UI.Page
    {
        ...
        DateTime fd = Util.Now;
        private DateTime td = Util.Now.AddDays(-60);
        ...
        {
            //FromDate.Text = "1/1/2008";
            //ToDate.Text = "12/31/2008";
        }
        ...
        protected void ProcessRequest(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=cn_stmt.txt");
            Response.Charset = "";
