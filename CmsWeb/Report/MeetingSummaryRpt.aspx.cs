...
namespace CmsWeb.Reports
{
    public partial class MeetingSummaryRpt : System.Web.UI.Page
    {
        ...
        private void RenderReport()
        {
            ...
            DbUtil.LogActivity("Viewing Meeting Summary Rpt");

            LocalReport localReport = new LocalReport();
            ReportDataSource rd1 = null;
            ReportDataSource rd2 = null;

            localReport.ReportPath = Server.MapPath("./rdlc/MeetingSummaryRpt.rdlc");
            ...
            rd1 = new ReportDataSource("PastAttendeeInfo", ctl.AbsenteesAndVisitors(mtgid.Value).ToList());
